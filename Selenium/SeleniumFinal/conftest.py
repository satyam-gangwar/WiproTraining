...
def driver():
    ...
    loggger.info(f'============================================')
    loggger.info(f'STARTING TEST')
    loggger.info(f'Reading Configuration')
    ...
    loggger.info(f'Opened browser: {browser}')
    driver.get(base_url)
    loggger.info(f'URL Loaded: {base_url}')
    yield driver
    driver.quit()
    loggger.info(f'Closing browser {browser}')
    loggger.info(f'Ending Test')
    loggger.info(f'==========================')